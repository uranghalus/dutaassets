    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          {/* Placeholder for Edit Action - could be a dialog trigger */}
        ...
        <Card className="md:col-span-1 h-fit">
          <CardContent className="pt-6 flex flex-col items-center text-center">
            ...
            <div className="mt-4 flex flex-wrap justify-center gap-2">
              <Badge
                variant={
                  employee.status_karyawan === "tetap" ? "default" : "secondary"
                }
              >
                {employee.status_karyawan}
              </Badge>
              <Badge variant="outline">{employee.divisi_fk.nama_divisi}</Badge>
            </div>
                        ...
                        <tbody>
                          {employee.assets.map((asset) => (
                            ...
                            >
                              ...
                              <td className="p-4">{asset.kategori_asset}</td>
